...
#[derive(Debug)]
pub struct EtherLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EtherLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EtherLink processing");
    
    let mut processor = EtherLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EtherLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EtherLinkProcessor::new(false);
